  ...
  schema: {
    collections: [
      ...
      },
      {
        ...
        fields: [{ type: 'object', name: 'products', label: 'Products', list: true, fields: [{ type: 'string', name: 'id', label: 'ID' }, { type: 'string', name: 'sku', label: 'SKU' }, localizedText('Name', 'name'), localizedText('Description', 'description', 'textarea'), { type: 'number', name: 'priceSek', label: 'Price SEK' }, { type: 'image', name: 'image', label: 'Image' }, { type: 'boolean', name: 'active', label: 'Active' }, { type: 'string', name: 'sizes', label: 'Sizes', list: true }] }],
      },
      {
        name: 'photography',
        label: 'Photography',
